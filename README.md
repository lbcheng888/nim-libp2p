...
| [fetch](libp2p/protocols/fetch/fetch.nim)                  | Key-value fetch protocol (`/libp2p/fetch/0.0.1`)                                                                 |
| [datatransfer](libp2p/protocols/datatransfer/datatransfer.nim) | Data Transfer control plane (`/p2p/datatransfer/1.2.0`)                                                          |
| [http](libp2p/protocols/http/http.nim)                     | HTTP/1.1 request-response over libp2p streams (`/http/1.1`)                                                      |
| [livestream](libp2p/protocols/livestream/livestream.nim)   | Live media streaming helpers (segment publish/subscribe with jitter buffer)                                     |
| [episub](libp2p/protocols/pubsub/episub/episub.nim)        | Proximity-aware gossip overlay (HyParView-based membership for GossipSub)                                       |
| **Transports**                                             |                                                                                                                  |
...
| [libp2p-tls](libp2p/protocols/secure/tls.nim)              | [TLS](https://github.com/libp2p/specs/blob/master/tls/tls.md) secure channel                                     |
...
| [record](libp2p/record.nim)                                | Generic libp2p record encoding/signing helpers for DHT-style key/value data |
| [discovery manager](libp2p/discovery/discoverymngr.nim)    | Discovery Manager                                                                                                |
| [mdns discovery](libp2p/discovery/mdns.nim)                | Local peer discovery through mDNS                                                                                |
| **Utilities**                                              |                                                                                                                  |
| [libp2p-crypto](libp2p/crypto)                             | Cryptographic backend                                                                                            |
| [libp2p-crypto-secp256k1](libp2p/crypto/secp.nim)          |                                                                                                                  |
| [pnet](libp2p/pnet.nim)                                    | Private network PSK loader and connection protector                                                              |
| **Pubsub**                                                 |                                                                                                                  |
...
| [episub](libp2p/protocols/pubsub/episub/episub.nim)        | Proximity aware router (HyParView + GossipSub)                                                                   |

> **Note**
> By default `SwitchBuilder` enables both Noise and TLS secure channels and advertises signed peer records so that Identify exchanges follow the libp2p specification.
