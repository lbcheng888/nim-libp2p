...
when defined(nimdoc):
  ...
  export
    ...
    multicodec, builders, pubsub, connectiongater, pnet, livestream, record, lsmr,
    memorymanager, delegatedrouting, noderesourceservice, mobilemeshservice, lsmrservice,
    wanbootstrapservice,
